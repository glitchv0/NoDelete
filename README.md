...
✅ **Block deletion attempts** - Shows warning popup instead of deleting
✅ **Block vendor sales** - Shows warning popup instead of selling  
✅ **Auto-buyback** - If somehow sold, automatically buys the item back
✅ **Work with drag-and-drop** - Prevents accidental selling by dragging to vendor
